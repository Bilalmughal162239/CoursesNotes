...
int dequeue() { return queue[front++]; }
    ...
    <ul class="list-disc list-inside text-gray-800">
      ...
      <li>Graphs are versatile for representing complex networks.</li>
    </ul>
  `,
          code: `
...
int main() {
  ...
  2. Write push/pop functions for stack with overflow and underflow checks.
  3. Write enqueue/dequeue functions for queue with overflow and underflow checks.
  4. Define and create binary tree nodes; practice simple traversal.
